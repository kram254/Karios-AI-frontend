...
const AutonomousTasksPage: React.FC = () => {
  ...
  if (!currentChat) {
    return (
      <div className="flex flex-col h-full bg-[#0A0A0A] text-white items-center justify-center gap-4">
        <Zap className="w-10 h-10 text-white/20" />
        <p className="text-sm text-white/40">Open a chat to view autonomous tasks.</p>
      </div>
    );
  }
